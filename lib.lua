...
local Backgrounds = {
	...
	["Abstract"] = 6073743880,
	["Bottom Fade"] = 8090210446,
	["Top Fade"] = 8090209856,
	["Astronauts In Space"] = 5608398904,
	["Fish"] = 6687255998
}
library.SettingsMenu:AddList({text = "Background", flag = "UI Background", max = 6, values = {"Floral", "Flowers", "Circles", "Hearts", "Polka dots", "Mountains", "Zigzag", "Zigzag 2", "Tartan", "Roses", "Hexagons", "Leopard print", "Abstract", "Bottom Fade", "Top Fade", "Astronauts In Space", "Fish"}, callback = function(Value)
